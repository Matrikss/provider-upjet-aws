...
func (mg *DistributionTenant) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("cloudfront.aws.m.upbound.io", "v1beta1", "MultitenantDistribution", "MultitenantDistributionList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
...
func (mg *MultitenantDistribution) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.DefaultCacheBehavior); i3++ {
		{
			m, l, err = apisresolver.GetManagedResource("cloudfront.aws.m.upbound.io", "v1beta1", "CachePolicy", "CachePolicyList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
